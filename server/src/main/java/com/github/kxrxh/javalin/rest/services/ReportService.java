...
public class ReportService {
    ...
    public static Map<String, Object> generateMonthlyReport(UUID userId, int year, int month) throws SQLException {
        ...
        Map<String, String> expenseDistributionChart = generateExpenseDistributionChart(expensesByCategory, totalExpenses);
        ...
        reportData.put("TrendAnalysis", "Comparison with the previous month (" + getMonthName(month - 1) + " " + year + "): Expenses increased by " + trend + "%");

        return reportData;
    }

    private static Map<String, Long> fetchTransactionSummary(Connection conn, UUID userId, int year, int month) throws SQLException {
    ...
    private static Map<String, Long> fetchExpensesByCategory(Connection conn, UUID userId, int year, int month) throws SQLException {
    ...
    private static Map<String, String> generateExpenseDistributionChart(Map<String, Long> expensesByCategory, long totalExpenses) {
    ...
    private static List<Map<String, String>> fetchLargestExpenses(Connection conn, UUID userId, int year, int month) throws SQLException {
