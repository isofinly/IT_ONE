...
/**
 * Collector for Jetty StatisticsHandler metrics to be used with Prometheus.
 */
public class StatisticsHandlerCollector extends Collector {
    ...
    /**
     * Initializes the StatisticsHandlerCollector with the provided
     * StatisticsHandler and registers it.
     *
     * @param statisticsHandler The StatisticsHandler instance to collect metrics
     *                          from.
     */
    ...
    /**
     * Collects metrics from the StatisticsHandler.
     *
    ...
    public List<MetricFamilySamples> collect() {
        return Arrays.asList(
                buildCounter("jetty_requests_total", "Number of requests",
                ...
                buildCounter("jetty_request_time_seconds_total",
                ...
                buildCounter("jetty_dispatched_time_seconds_total",
                ...
                buildGauge("jetty_async_requests_waiting_max",
                ...
                buildCounter("jetty_expires_total",
                ...
                buildCounter("jetty_responses_bytes_total",
